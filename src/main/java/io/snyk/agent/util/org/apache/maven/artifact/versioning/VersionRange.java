package io.snyk.agent.util.org.apache.maven.artifact.versioning;
...
public class VersionRange {
    ...
    public static VersionRange createFromVersionSpec(String spec)
        ...
        while (process.startsWith("[") || process.startsWith("(")) {
            ...
            if (index < 0) {
                throw new IllegalStateException("Unbounded range: " + spec);
            }
            ...
            if (upperBound != null) {
                if (restriction.getLowerBound() == null || restriction.getLowerBound().compareTo(upperBound) < 0) {
                    throw new IllegalStateException("Ranges overlap: " + spec
                            + " // " + restriction.getLowerBound() + " // " + upperBound);
                }
            }
    ...
    private static Restriction parseRestriction(String spec)
        ...
        if (index < 0) {
            if (!lowerBoundInclusive || !upperBoundInclusive) {
                throw new IllegalStateException("Single version must be surrounded by []: " + spec);
            }
            ...
            if (lowerBound.equals(upperBound)) {
                throw new IllegalStateException("Range cannot have identical boundaries: " + spec);
            }
            ...
            if (upperVersion != null && lowerVersion != null && upperVersion.compareTo(lowerVersion) < 0) {
                throw new IllegalStateException("Range defies version ordering: " + spec);
            }
...
/* TODO should throw this immediately, but need artifact
        ...
        {
            throw new IllegalStateException( "Restricting incompatible version ranges" );
        }
*/
